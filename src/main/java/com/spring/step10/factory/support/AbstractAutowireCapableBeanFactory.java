...
import com.spring.step10.aware.Aware;
import com.spring.step10.aware.BeanClassLoaderAware;
import com.spring.step10.aware.BeanFactoryAware;
import com.spring.step10.aware.BeanNameAware;
import com.spring.step10.entity.BeanDefinition;
import com.spring.step10.entity.BeanReference;
import com.spring.step10.entity.PropertyValues;
import com.spring.step10.exception.BeanException;
import com.spring.step10.factory.AutowireCapableBeanFactory;
import com.spring.step10.factory.DisposableAdapter;
import com.spring.step10.factory.DisposableBean;
import com.spring.step10.factory.InitializingBean;
import com.spring.step10.postprocessor.BeanPostProcessor;
import com.spring.step10.strategy.CglibStrategy;
import com.spring.step10.strategy.InstantiationStrategy;
  ...
  private Object initializeBean(String beanName, Object bean, BeanDefinition beanDefinition){
    ...
    if (bean instanceof Aware){
      ...
      if (bean instanceof BeanClassLoaderAware){
        ((BeanClassLoaderAware) bean).setClassLoader(ClassUtil.getClassLoader());
      }
